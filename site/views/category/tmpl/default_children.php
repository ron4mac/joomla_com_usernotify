...
<?php foreach($this->children[$this->category->id] as $id => $child) : ?>
	...
	<li<?php echo $class; ?>>
		<?php $class = ''; ?>
			<span class="item-title"><a href="<?php echo JRoute::_(UserNotifyHelperRoute::getCategoryRoute($child->id));?>">
			...
			<dl class="usersubs-count"><dt>
				<?php echo JText::_('COM_USERNOTIFY_NUM'); ?></dt>
