<?php
/**
 * @version		$Id: usersubs.php 20899 2011-03-07 20:56:09Z ian $
 ...
 * @since		1.5
 */
class UserNotifyControllerUserSubs extends JControllerForm
{
	/**
	 * @since	1.6
	 */
	...
	protected function postSaveHook(JModel &$model, $validData = array())
	{
		...
		if ($task == 'save') {
			$this->setRedirect(JRoute::_('index.php?option=com_usernotify&view=category&id='.$validData['catid'], false));
		}
	}
	...
	public function go()
	{
		...
		$modelLink	= $this->getModel('UserSubs', '', array('ignore_request' => true));
		...
		if (empty($link)) {
			return JError::raiseWarning(404, JText::_('COM_USERNOTIFY_ERROR_USERSUBS_NOT_FOUND'));
		}
		...
		$modelCat = $this->getModel('Category', 'UserNotifyModel', array('ignore_request' => true));
		...
		if ($link->url) {
			...
			return JError::raiseWarning(404, JText::_('COM_USERNOTIFY_ERROR_USERSUBS_URL_INVALID'));
		}
	}
}
